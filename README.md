...
睡前故事的关键不是把声音做得很戏剧化，而是让语速稳定、音量略低、情绪不要起伏太大。播放器会把已生成的 MP3 以 0.78 倍速播放，并在开始时做轻微淡入；慢速播放时保持原音高，避免手机浏览器在变速降调时出现杂音。如果重新生成音频，以上 edge-tts 参数也会让新文件本身更慢、更低。背景音建议从 8% 到 12% 之间试，雨声可以稍高一点，翻书声和壁炉声要更低。
